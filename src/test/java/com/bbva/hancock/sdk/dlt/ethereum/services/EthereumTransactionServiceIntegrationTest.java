...
public class EthereumTransactionServiceIntegrationTest {
    ...
    @Test
    public void testSendWithSendRawTx() throws Exception {

        final TransactionConfig txConfig = new TransactionConfig.Builder()
                .build();

        final EthereumTransactionResponse rawtx = spyTransactionClient.send(txRequest, txConfig);
    ...
    @Test
    public void testSendWithSendSigned() throws Exception {
    ...
    @Test
    public void testSendWithSendToSign() throws Exception {
