...
public class HancockEthereumClient {
    ...
    public EthereumWallet generateWallet() throws HancockException {
        ...
        try {
            ...
            throw new HancockException(HancockTypeErrorEnum.ERROR_INTERNAL, "50001", 500, HancockErrorEnum.ERROR_WALLET.getMessage() , HancockErrorEnum.ERROR_WALLET.getMessage(), error);
    ...
    protected <T> T checkStatus(Response response, Class<T> tClass) throws HancockException {
        ...
        try (ResponseBody responseBody = response.body()) {
          ...
          throw new HancockException(HancockTypeErrorEnum.ERROR_INTERNAL, "50002", 500, HancockErrorEnum.ERROR_CHECK.getMessage() , HancockErrorEnum.ERROR_CHECK.getMessage(), error);
    ...
    protected Response makeCall(Request request) throws HancockException {
      ...
      try{
        ...
        throw new HancockException(HancockTypeErrorEnum.ERROR_INTERNAL, "50003", 500, HancockErrorEnum.ERROR_HTTP.getMessage() , HancockErrorEnum.ERROR_HTTP.getMessage(), error);
