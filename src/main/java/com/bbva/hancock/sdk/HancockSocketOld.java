...
import com.bbva.hancock.sdk.models.socket.HancockSocketMessage;
import com.bbva.hancock.sdk.models.socket.HancockSocketRequest;
...
public class HancockSocketOld {

    private final WebSocketClient ws;
    private final Map<String, List<Function>> callbackFunctions;

    public HancockSocketOld(String url) throws URISyntaxException {
